  ...
  <div class="wrapper blog-roll ad-pad clearfix">
    ...
    <div class="col-sm-12 col-md-9 body-sub screen-w-right-in">
      <div class="clearfix post body-main-sub">
        <!--<iframe frameborder="0" height="1200" scrolling="yes" src="https://www.warpdoball.com/fullscreen-table" width="100%"></iframe>-->
        <iframe id="ifrm" frameborder="0" width="100%" height="700" src="https://www.warpdoball.com/fullscreen-table" onload="setIframeHeight(this.id)"></iframe>
      </div>
    </div>
    <!-- Start Right Sidebar  -->
