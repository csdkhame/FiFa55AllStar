              ...
              <div class="col-md-4">
                <div class="media wow flipInX" data-wow-delay="0.3s">
                  ...
                  <div class="media-body">
                    ...
                    <p align="right">สมาชิก <?=$fifa55;?> ที่เข้ามาเดิมพันกับทางเว็บ </p>
                    <p align="right"><?=$fifa55;?> ไม่ต้องกังวลทางทีมงานพร้อมให้บริการอย่างเต็มที่โดยไร้ปัญหา</p>
                  </div>
                </div>
                <!--media-->
              </div>
              <div class="col-md-4">
                <div class="media wow flipInX" data-wow-delay="0.6s">
                  ...
                  <div class="media-body">
                    ...
                    <p align="right"><?=$fifa55;?> เว็บตรงจาก <?=$fifa55;?> </p>
                    <p align="right">ไม่ผ่านเอเย่นต์ การเงินมั่นคง จ่ายจริง จ่ายไว จ่ายไม่อั้น</p>
                  </div>
                </div>
                <!--media-->
              </div>
              <div class="col-md-4">
                <div class="media wow flipInX" data-wow-delay="0.9s">
                  ...
                  <div class="media-body">
                    ...
                    <p align="right"><?=$fifa55;?> เดิมพันออนไลน์สุดคุ้ม กับโปรโมชั่นสนุก ๆ </p>
                    <p align="right">ลุ้นรับรางวัลใหญ่ ที่ทางเราจัดให้สมาชิกกันตลอด</p>
                  </div>
                </div>
                <!--media-->
              </div>
              <div class="col-md-4">
                <div class="media wow flipInX" data-wow-delay="1.2s">
                  ...
                  <div class="media-body">
                    ...
                    <p align="right"><?=$fifa55;?> เดิมพันกีฬาออนไลน์หลายชนิด ไก่ชนออนไลน์ </p>
                    <p align="right">เล่นคาสิโนแบบสดๆ ทั้งหมดนี้อยู่ในบัญชีใช้งาน เพียงบัญชีเดียว !!</p>
                  </div>
                </div>
                <!--media-->
              </div>
              <div class="col-md-4">
                <div class="media wow flipInX" data-wow-delay="1.5s">
                  ...
                  <div class="media-body">
                    ...
                    <p align="right"><?=$fifa55;?> เล่นผ่านมือถือได้ตลอดทั้งวัน สะดวกสบาย ประหยัดเวลา </p>
                    <p align="right">ถูกใจนักเดิมพันที่เดินทางอยู่สม่ำเสมอ</p>
                  </div>
                </div>
                <!--media-->
              </div>
              <div class="col-md-4">
                <div class="media wow flipInX" data-wow-delay="1.8s">
                  ...
                  <div class="media-body">
                    ...
                    <p align="right">สามารถรับชมการถ่ายทอดสดฟุตบอลได้ทุกลีกทั่วโลกที่ </p>
                    <p align="right"><?=$fifa55;?> คมชัดระดับ HD และไม่มีโฆษณามากวนใจตลอดการแข่งขันที่นี่</p>
                  </div>
                </div>
                <!--media-->
              </div>
